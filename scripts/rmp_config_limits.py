...
config_params_max = dict({ 
					...
					RMP_CMD_SET_ETH_IP_ADDRESS:0,
					RMP_CMD_SET_ETH_PORT_NUMBER:0,
					RMP_CMD_SET_ETH_SUBNET_MASK:0,
					RMP_CMD_SET_ETH_GATEWAY:0,
...
config_params_function = dict({ 
					...
					RMP_CMD_SET_USER_FB_1_BITMAP:isPositive,
					RMP_CMD_SET_USER_FB_2_BITMAP:isPositive,
					RMP_CMD_SET_USER_FB_3_BITMAP:isPositive,
					RMP_CMD_SET_USER_FB_4_BITMAP:isPositive,
